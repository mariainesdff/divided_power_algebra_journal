...
import DividedPowerAlgebra.ForMathlib.Algebra.Algebra.Bilinear --required for the last two lemmas
import DividedPowerAlgebra.ForMathlib.LinearAlgebra.TensorProduct.Pi --required for the last lemma
